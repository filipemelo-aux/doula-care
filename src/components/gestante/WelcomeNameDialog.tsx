...
export function WelcomeNameDialog({ fullName, userId, onComplete }: WelcomeNameDialogProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-background/80 backdrop-blur-sm p-4">
      <div className="w-full max-w-md rounded-2xl bg-gradient-to-br from-secondary via-primary/5 to-accent/10 shadow-2xl p-8 space-y-6 animate-in fade-in zoom-in-95 duration-500">
        {/* Decorative header */}

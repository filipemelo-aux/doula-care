...
export function Sidebar({ isOpen, onToggle, onNavigate }: SidebarProps) {
  ...
  return (
    <aside
      className={cn(
        "fixed top-[var(--app-safe-top)] bottom-[var(--app-safe-bottom)] left-0 z-50 flex flex-col bg-sidebar border-r border-sidebar-border transition-all duration-300 ease-in-out",

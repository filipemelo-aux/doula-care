    ...
    >
      ...
      <div className="h-20 flex items-center justify-between px-6 border-b border-sidebar-border">
        <div className={cn("flex items-center gap-3 transition-opacity", !isOpen && "lg:opacity-0")}>
          <div className="w-11 h-11 rounded-[70%] bg-[#FFF5EE] flex items-center justify-center overflow-hidden">
            <img src={logo} alt="Papo de Doula" className="w-[85%] h-[85%] object-contain" />
          </div>
          <div>
      ...
      {!isOpen && (
        <div className="hidden lg:flex h-20 absolute top-0 left-0 w-20 items-center justify-between px-2">
          <div className="w-10 h-10 rounded-[70%] bg-[#FFF5EE] flex items-center justify-center overflow-hidden">
            <img src={logo} alt="Papo de Doula" className="w-[85%] h-[85%] object-contain" />
          </div>
          <Button
            variant="ghost"

...
export function StatCard({
  ...
  return (
    <div
      className={cn(
        "stat-card overflow-hidden p-3 lg:p-5",
    ...
    >
      <div className="flex items-start justify-between mb-2 lg:mb-4">
        ...
        {trend && (
          <div
            className={cn(
              "px-1.5 py-0.5 lg:px-2.5 lg:py-1 rounded-full text-[10px] lg:text-xs font-medium flex-shrink-0",
              trend.isPositive
      ...
      <div className="min-w-0">
        <h3
          className={cn(
            "text-[10px] lg:text-sm font-medium mb-0.5 lg:mb-1 truncate",
        ...
        {subtitle && (
          <p
            className={cn(
              "text-[9px] lg:text-sm mt-0.5 lg:mt-1 truncate hidden lg:block",
              variant === "default" && "text-muted-foreground",

      ...
      <div className="min-h-full pb-10">
        ...
        <div className="sticky top-0 z-10 bg-background/85 backdrop-blur-md border-b border-border/40">
          <div className="flex items-center justify-between px-3 py-2.5">
            ...
            <p className="text-xs text-muted-foreground font-medium">{info.trimester}</p>
          </div>
        </div>

        {/* Hero */}
        <div className="px-4 pt-4">
          <div className="rounded-3xl overflow-hidden bg-gradient-to-br from-secondary via-secondary/70 to-primary/15 dark:from-primary/15 dark:via-primary/10 dark:to-accent/10 shadow-[0_12px_40px_-16px_hsl(var(--primary)/0.4)] p-4 relative">
            <div className="flex items-start justify-between mb-1">
              ...
              <div className="text-right max-w-[55%]">
                <p className="text-[11px] text-foreground/70">Seu bebê está do tamanho de um</p>
        ...
        {info.development.length > 0 && (
          <section className="px-4 mt-6">
            ...
            <ul className="space-y-2">
              {info.development.map((item, i) => (
                <li
                  key={i}
                  className="flex items-start gap-3 rounded-2xl bg-card border border-border/40 px-4 py-3 shadow-sm"
                >

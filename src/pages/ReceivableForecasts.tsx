...
export default function ReceivableForecasts() {
  ...
  return <div className="space-y-4 lg:space-y-6 pb-28">
    <div className="page-header mb-0"><p className="mb-1 text-[10px] font-bold uppercase text-primary">Financeiro</p><h1 className="page-title">Previsões de Recebimento</h1><p className="page-description">Confira os serviços realizados antes de gerar a fatura.</p></div>

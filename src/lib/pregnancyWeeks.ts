...
export const PREGNANCY_WEEKS: WeekInfo[] = [
  ...
  { week: 2, fruit_name: "semente de gergelim", fruit_emoji: "🌾", baby_size_cm: "0,2 mm", baby_weight: "<1 g", description: "Implantação no endométrio e formação do saco gestacional. A vesícula vitelina e a cavidade amniótica começam a aparecer.", tip: "Mantenha uma alimentação rica em nutrientes e hidrate-se bem." },

...
export const PREGNANCY_WEEKS: WeekInfo[] = [
  ...
  { week: 4, fruit_name: "semente de chia", fruit_emoji: "🌱", baby_size_cm: "2–4 mm", baby_weight: "<1 g", description: "Organogênese e dobramento do embrião! Tubo neural se fecha, surge a protuberância cardíaca e os primeiros somitos (futuras vértebras) aparecem (aprox. 22–28 dias).", tip: "Mantenha o ácido fólico — ele é essencial para o fechamento do tubo neural." },

...
export const PREGNANCY_WEEKS: WeekInfo[] = [
  ...
  { week: 2, fruit_name: "semente de papoula", fruit_emoji: "⚫", baby_size_cm: "0,2 mm", baby_weight: "<1 g", description: "Blastocisto totalmente implantado e saco gestacional inicial em formação (aprox. 10–14 dias). A vesícula vitelina e a cavidade amniótica começam a aparecer.", tip: "Mantenha uma alimentação rica em nutrientes e hidrate-se bem." },
  { week: 3, fruit_name: "semente de gergelim", fruit_emoji: "🌾", baby_size_cm: "1–2 mm", baby_weight: "<1 g", description: "Gastrulação! Forma-se o disco embrionário trilaminar (ectoderme, mesoderme e endoderme), origem de todos os tecidos do bebê (aprox. 15–21 dias).", tip: "Mantenha o ácido fólico em dia — essencial para a formação do tubo neural." },

...
export const PREGNANCY_WEEKS: WeekInfo[] = [
  { week: 1, fruit_name: "semente de chia", fruit_emoji: "🌱", baby_size_cm: "0,1–0,2 mm", baby_weight: "<1 g", description: "Mórula e blastocisto inicial! Após a fecundação, o aglomerado de células viaja pela trompa e começa a se implantar no útero (aprox. 5–7 dias).", tip: "Comece a tomar ácido fólico se ainda não toma — ele é essencial nas primeiras semanas." },
  { week: 2, fruit_name: "semente de gergelim", fruit_emoji: "🌱", baby_size_cm: "0,2 mm", baby_weight: "<1 g", description: "Implantação e formação do saco gestacional! O blastocisto se implanta profundamente no endométrio uterino e o disco embrionário bilaminar começa a se formar (aprox. 10–14 dias).", tip: "Mantenha uma alimentação rica em nutrientes e hidrate-se bem." },
  { week: 3, fruit_name: "grão de mostarda", fruit_emoji: "🌾", baby_size_cm: "1–2 mm", baby_weight: "<1 g", description: "Gastrulação! Forma-se o disco embrionário trilaminar (ectoderme, mesoderme e endoderme), origem de todos os tecidos do bebê (aprox. 15–21 dias).", tip: "Mantenha o ácido fólico em dia — essencial para a formação do tubo neural." },
  { week: 4, fruit_name: "semente de papoula", fruit_emoji: "⚫", baby_size_cm: "~1 mm", baby_weight: "<1 g", description: "Implantação concluída! O saco gestacional e o embrião já estão implantados na parede uterina (aprox. 1 mm). Início da produção de hCG e formação do disco embrionário.", tip: "Mantenha o ácido fólico — ele é essencial para o fechamento do tubo neural." },
  { week: 5, fruit_name: "semente de chia", fruit_emoji: "🌱", baby_size_cm: "5 mm", baby_weight: "<1 g", description: "Embrião em formato de C! Tubo neural se fechando, primórdios cardíacos com batimento inicial e brotos dos membros aparecendo.", tip: "Marque sua primeira consulta de pré-natal." },
  { week: 6, fruit_name: "grão de pimenta preta", fruit_emoji: "⚫", baby_size_cm: "5-6 mm", baby_weight: "<1 g", description: "Início da formação das feições faciais e dos membros! Brotos de braços e pernas ficam mais visíveis e o coração já bate em ritmo acelerado.", tip: "Enjoos podem aparecer — coma pequenas porções ao longo do dia." },

...
export const PREGNANCY_WEEKS: WeekInfo[] = [
  { week: 1, fruit_name: "semente de chia", fruit_emoji: "🌱", baby_size_cm: "0,1 mm", baby_weight: "<1 g", description: "Fecundação e início da divisão celular! O zigoto se forma na trompa de Falópio e começa sua jornada até o útero.", tip: "Comece a tomar ácido fólico se ainda não toma — ele é essencial nas primeiras semanas." },

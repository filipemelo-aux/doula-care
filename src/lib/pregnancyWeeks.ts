...
export const PREGNANCY_WEEKS: WeekInfo[] = [
  ...
  { week: 3, fruit_name: "mirtilo pequeno", fruit_emoji: "🫐", baby_size_cm: "0,2 mm", baby_weight: "<1 g", description: "Gastrulação! O embrião forma o disco trilaminar (ectoderme, mesoderme e endoderme), origem de todos os tecidos do bebê.", tip: "Mantenha o ácido fólico em dia — essencial para a formação do tubo neural." },
  { week: 4, fruit_name: "semente de gergelim", fruit_emoji: "🌾", baby_size_cm: "4 mm", baby_weight: "<1 g", description: "Início da organogênese! Tubo neural quase fechado, primórdio cardíaco já bate e os primeiros somitos (futuras vértebras) aparecem.", tip: "Mantenha o ácido fólico — ele é essencial para o fechamento do tubo neural." },
